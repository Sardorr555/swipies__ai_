...
GH_AUTH_HEADER="Authorization: token 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"

curl -fsSL -H "${GH_AUTH_HEADER}" -o docker-compose.yml https://raw.githubusercontent.com/Sardorr555/swipies__ai_/licence_v/docker/docker-compose.release.yml 2>/dev/null || \
...
curl -fsSL -H "${GH_AUTH_HEADER}" -o docker-compose-base.yml https://raw.githubusercontent.com/Sardorr555/swipies__ai_/licence_v/docker/docker-compose-base.yml 2>/dev/null || \
...
curl -fsSL -H "${GH_AUTH_HEADER}" -o service_conf.yaml.template https://raw.githubusercontent.com/Sardorr555/swipies__ai_/licence_v/docker/service_conf.yaml.template 2>/dev/null || \
...
curl -fsSL -H "${GH_AUTH_HEADER}" -o .env https://raw.githubusercontent.com/Sardorr555/swipies__ai_/licence_v/docker/.env 2>/dev/null || \
