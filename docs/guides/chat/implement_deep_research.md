...
From v0.17.0 onward, Swipies supports integrating agentic reasoning in an AI chat. The following diagram illustrates the workflow of Swipies's deep research:
