...
:::caution WARNING
The feature is disabled by default. If your dataset contains spreadsheets with complex tables, and you do not enable this feature, Swipies will not throw an error but your tables are likely to be garbled.
:::
