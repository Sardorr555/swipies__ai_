...
- [.env](https://github.com/Sardorr555/swipies__ai_.git/blob/main/docker/.env): Contains important environment variables for Docker.
- [service_conf.yaml.template](https://github.com/Sardorr555/swipies__ai_.git/blob/main/docker/service_conf.yaml.template): Configures the back-end services. It specifies the system-level configuration for RAGFlow and is used by its API server and task executor. Upon container startup, the `service_conf.yaml` file will be generated based on this template file. This process replaces any environment variables within the template, allowing for dynamic configuration tailored to the container's environment.
- [docker-compose.yml](https://github.com/Sardorr555/swipies__ai_.git/blob/main/docker/docker-compose.yml): The Docker Compose file for starting up the RAGFlow service.

To update the default HTTP serving port (80), go to [docker-compose.yml](https://github.com/Sardorr555/swipies__ai_.git/blob/main/docker/docker-compose.yml) and change `80:80`
...
The [.env](https://github.com/Sardorr555/swipies__ai_.git/blob/main/docker/.env) file contains important environment variables for Docker.
...
[service_conf.yaml.template](https://github.com/Sardorr555/swipies__ai_.git/blob/main/docker/service_conf.yaml.template) specifies the system-level configuration for RAGFlow and is used by its API server and task executor.
