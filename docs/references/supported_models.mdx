...
:::note
The list of supported models is extracted from [this source](https://github.com/Sardorr555/swipies__ai_.git/blob/main/rag/llm/__init__.py) and may not be the most current. For the latest supported model list, please refer to the Python file.
:::
