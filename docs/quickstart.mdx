...
- [gVisor](https://gvisor.dev/docs/user_guide/install/): Required only if you intend to use the code executor ([sandbox](https://github.com/Sardorr555/swipies__ai_.git/tree/main/sandbox)) feature of RAGFlow.
