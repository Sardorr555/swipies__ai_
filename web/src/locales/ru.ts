...
[Вставьте текст здесь]`,
    ...
    privacyPolicy: {
      ...
      section9Title: '9. Свяжитесь с нами',
      section9Text:
        'Если у вас есть вопросы или опасения относительно настоящей Политики конфиденциальности или ваших персональных данных, пожалуйста, свяжитесь с нами по адресу: {{email}}',
    },
  },
};
