...
[Вставьте текст здесь]`,
    ...
    privacyPolicy: {
      ...
      section1Text:
        'Добро пожаловать в Swipies («мы», «наш», «нас»). Мы ценим вашу конфиденциальность и стремимся защитить ваши персональные данные. Настоящая Политика конфиденциальности объясняет, как мы собираем, используем, храним и защищаем вашу информацию при использовании платформы Swipies и её сервисов.',
      section2Title: '2. Какие данные мы собираем',
      section2Text:
        'Мы можем собирать следующие категории персональных данных:',
      section2Item1:
        'Данные учётной записи: имя (никнейм), адрес электронной почты, номер телефона и пароль (хранится в зашифрованном виде).',
      section2Item2:
        'Данные об использовании: информация о том, как вы взаимодействуете с нашей платформой, включая посещённые страницы, используемые функции и временные метки.',
      section2Item3:
        'Контентные данные: документы, наборы данных и другие файлы, которые вы загружаете или создаёте на платформе.',
      section2Item4:
        'Технические данные: IP-адрес, тип браузера, информация об устройстве и операционная система.',
      section3Title: '3. Как мы используем ваши данные',
      section3Text: 'Мы используем ваши персональные данные в следующих целях:',
      section3Item1:
        'Для предоставления и поддержки наших услуг, включая управление учётными записями и контроль доступа.',
      section3Item2:
        'Для улучшения и персонализации пользовательского опыта на нашей платформе.',
      section3Item3:
        'Для связи с вами по вопросам вашей учётной записи, обновлений и обращений в поддержку.',
      section3Item4:
        'Для обеспечения безопасности нашей платформы и предотвращения мошенничества или несанкционированного доступа.',
      section3Item5:
        'Для соблюдения правовых обязательств и нормативных требований.',
      section4Title: '4. Хранение и безопасность данных',
      section4Text:
        'Мы применяем отраслевые стандарты безопасности, включая шифрование, контроль доступа и защищённую серверную инфраструктуру для защиты ваших персональных данных. Ваши данные хранятся на защищённых серверах и доступны только уполномоченному персоналу. Мы храним ваши данные до тех пор, пока ваша учётная запись активна, или столько, сколько необходимо для выполнения целей, изложенных в данной политике.',
      section5Title: '5. Передача данных третьим лицам',
      section5Text:
        'Мы не продаём, не обмениваем и не сдаём в аренду ваши персональные данные третьим лицам. Мы можем передавать анонимизированные, агрегированные данные для аналитических целей. Мы можем раскрыть персональные данные, если это требуется по закону, решению суда или государственному постановлению, или для защиты прав и безопасности Swipies и её пользователей.',
      ...
      section6Item2:
        'Право на исправление: вы можете обновить или исправить неточные персональные данные через настройки вашей учётной записи.',
      section6Item3:
        'Право на удаление: вы можете запросить удаление вашей учётной записи и связанных данных, обратившись в службу поддержки.',
      section7Title: '7. Файлы cookie и отслеживание',
      section7Text:
        'Мы используем файлы cookie и аналогичные технологии для поддержания состояния сеанса, запоминания ваших предпочтений и улучшения наших услуг. Вы можете управлять настройками cookie через настройки вашего браузера. Отключение cookie может повлиять на работу некоторых функций.',
