...
Пример: Virtual Hosted Style`,
      ...
      deleteAccountDescription: 'После удаления ваш аккаунт станет неактивным, но ваши данные будут сохранены в системе.',
      deleteAccountBtn: 'Деактивировать аккаунт',
      deleteAccountConfirmTitle: 'Подтверждение деактивации аккаунта',
      deleteAccountConfirmContent: 'Вы уверены, что хотите деактивировать свой аккаунт? Вы сразу же выйдете из системы и не сможете войти снова. Ваши данные и созданные базы знаний будут сохранены.',
      maxTokens: 'Макс. Токенов',
