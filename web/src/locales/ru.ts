...
Пример: Virtual Hosted Style`,
      ...
      deleteAccountConfirmContent: 'Вы уверены, что хотите удалить свой аккаунт? Данное действие абсолютно необратимо, и этот аккаунт нельзя будет восстановить вообще под любым предлогом. Вы выйдете из системы немедленно.',
      maxTokens: 'Макс. Токенов',
