...
[Вставьте текст здесь]`,
    ...
    privacyPolicy: {
      ...
      effectiveDate: 'Дата последнего обновления',
      ...
      section8Title: '8. Регламент технического обслуживания (Scheduled Maintenance)',
      section8Text:
        'Плановое техническое обслуживание проводится в часы минимальной нагрузки. Пользователи уведомляются о плановых работах не менее чем за 48 часов через интерфейс платформы. Время планового обслуживания не учитывается при расчете компенсаций Uptime SLA.',
      section9Title: '9. Классификация инцидентов и SLA поддержки',
      section9Text:
        'Служба поддержки классифицирует обращения по уровню критичности (Severity Level) со следующими нормативными сроками реагирования:',
      section9Item1:
        'Критический (P1 - Полный сбой основной функциональности): реакция до 15 минут, статус обновляется каждые 30 минут.',
      section9Item2:
        'Высокий (P2 - Существенное снижение производительности или сбой части функций): реакция до 1 часа.',
      section9Item3:
        'Средний (P3 - Локальная незначительная ошибка с возможностью обхода): реакция до 4 часов.',
      section9Item4:
        'Низкий (P4 - Консультации, вопросы по настройке и пожелания): реакция до 8 рабочих часов.',
      section10Title: '10. Сроки хранения и регламент полного удаления данных',
      section10Text:
        'Ваши данные хранятся на серверах только в период действия учетной записи. Вы имеете право в любой момент физически удалить любой чат, базу знаний, файл или аккаунт целиком. При инициации удаления данные физически и безвозвратно стираются из всех баз данных, объектных хранилищ S3 и векторных индексов.',
      section11Title: '11. Контроль доступа (RBAC) и внутренний аудит',
      section11Text:
        'Доступ к информации строго регламентирован моделью Role-Based Access Control (RBAC). Доступ сотрудников платформы к пользовательскому контенту закрыт технически и юридически. Допуск инженера возможен только при наличии письменной заявки пользователя в службу поддержки.',
      section12Title: '12. Использование файлов Cookie и токенов сессий',
      section12Text:
        'Платформа использует исключительно необходимые сессионные Cookie и LocalStorage для обеспечения безопасной работы JWT-авторизации, сохранения выбранного языка, цветовой темы и интерфейсных предпочтений.',
      section13Title: '13. Соответствие стандартам безопасности (Compliance)',
      section13Text:
        'Инфраструктура платформы Swipies спроектирована с соблюдением требований международных стандартов защиты персональных данных (GDPR-ready), обеспечивая право пользователей на доступ, исправление, ограничение обработки и полное удаление данных («право на забвение»).',
      section14Title: '14. Права пользователей и порядок принятия SLA',
      section14Text:
        'Использование платформы Swipies, регистрация аккаунта или активация функций ИИ-ассистентов подтверждают полное и безоговорочное согласие пользователя с настоящим Соглашением об уровне обслуживания и Политикой обработки данных.',
      section15Title: '15. Контакты службы безопасности и DPO',
      section15Text:
        'По всем вопросам информационной безопасности, условий SLA, обработки данных или подачи запросов на удаление вы можете обратиться к нашему офицеру по защите данных по адресу: {{email}}',
    },
  },
};
