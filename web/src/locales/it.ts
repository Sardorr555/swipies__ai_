...
Esempio: un messaggio di 1 KB con embedding a 1024 dimensioni usa ~9 KB. Il limite predefinito di 5 MB contiene ~500 messaggi di questo tipo.`,
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        'Esegui un test di recupero per verificare se Swipies riesce a recuperare il contenuto previsto per il LLM.',
      Parse: 'Analizza',
      dataset: 'Dataset',
      ...
      uploadDescription:
        "Supporta caricamento singolo o multiplo. Per un Swipies distribuito localmente: il limite di dimensione totale dei file per caricamento è 1GB, con un limite batch di 32 file. Non c'è limite al numero totale di file per account. Per cloud.swipies.io, il limite di dimensione totale dei file per caricamento è 10MB, con ogni file non superiore a 10MB e un massimo di 128 file per account.",
      chunk: 'Chunk',
      bulk: 'Multiplo',
      cancel: 'Annulla',
      close: 'Chiudi',
      ...
      rerankTip: `Opzionale. Se lasciato vuoto, Swipies userà una combinazione di similarità delle parole chiave ponderata e similarità coseno vettoriale ponderata; se viene selezionato un modello rerank, un punteggio di reranking ponderato sostituirà la similarità coseno vettoriale ponderata. Tieni presente che l'uso di un modello rerank aumenterà significativamente il tempo di risposta del sistema. Se desideri usare un modello rerank, assicurati di usare un reranker SaaS; se preferisci un modello rerank distribuito localmente, assicurati di avviare Swipies con docker-compose-gpu.yml.`,
      topK: 'Top-K',
...
`,
    ...
    knowledgeConfiguration: {
      ...
      tableColumnModeAutoDescription:
        'Tutte le colonne sono incluse nel testo del chunk e memorizzate come metadati (predefinito Swipies).',
...
**Regole essenziali:**
  ...
  - **Considera sempre** l'intera cronologia della conversazione.`,
      ...
      **Regole essenziali:**
      ...
      betaError:
        'Per favore acquisisci prima una chiave API Swipies dalla pagina Impostazioni di sistema.',
