export default {
  translation: {
    ...
    login: {
      loginTitle: 'Welcome to the Most Epic AI Platform Ever Created 🚀',
      signUpTitle: 'Join the Ultimate AI Experience ✨',
      login: 'Sign in',
      signUp: 'Sign up',
      loginDescription: 'We’re super excited to see you again! Ready for new AI power? 🔥',
      registerDescription: 'Your journey into the future of artificial intelligence starts here! 🌟',
      emailLabel: 'Email',
...
Example: A 1 KB message with 1024-dim embedding uses ~9 KB. The 5 MB default limit holds ~500 such messages.`,
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        'Conduct a retrieval test to check if Swipies can recover the intended content for the LLM.',
      Parse: 'Parse',
      dataset: 'Dataset',
      ...
      uploadDescription:
        'Supports single or batch file upload. For a locally deployed Swipies: the total file size limit per upload is 1GB, with a batch upload limit of 32 files. There is no cap on the total number of files per account. For cloud.swipies.io, the total file size limit per upload is 10MB, with each file not exceeding 10MB and a maximum of 128 files per account.',
      chunk: 'Chunk',
      bulk: 'Bulk',
      cancel: 'Cancel',
      close: 'Close',
      ...
      rerankTip: `Optional. If left empty, Swipies will use a combination of weighted keyword similarity and weighted vector cosine similarity; if a rerank model is selected, a weighted reranking score will replace the weighted vector cosine similarity. Please be aware that using a rerank model will significantly increase the system's response time. If you wish to use a rerank model, ensure you use a SaaS reranker; if you prefer a locally deployed rerank model, ensure you start Swipies with docker-compose-gpu.yml.`,
      topK: 'Top-K',
      ...
      html4excelTip: `Use with the General chunking method. When disabled, spreadsheets (XLSX or XLS(Excel 97-2003)) in the dataset will be parsed into key-value pairs. When enabled, they will be parsed into HTML tables, splitting every 12 rows if the original table has more than 12 rows. See https://docs.swipies.app/docs/dev/enable_excel2html for details.`,
      autoKeywords: 'Auto-keyword',
      autoKeywordsTip: `Automatically extract N keywords for each chunk to increase their ranking for queries containing those keywords. Be aware that extra tokens will be consumed by the indexing model specified in 'Configuration'. You can check or update the added keywords for a chunk from the chunk list. For details, see https://docs.swipies.app/docs/dev/autokeyword_autoquestion.`,
      autoQuestions: 'Auto-question',
      autoQuestionsTip: `Automatically extract N questions for each chunk to increase their ranking for queries containing those questions. You can check or update the added questions for a chunk from the chunk list. This feature will not disrupt the chunking process if an error occurs, except that it may add an empty result to the original chunk. Be aware that extra tokens will be consumed by the indexing model specified in 'Configuration'. For details, see https://docs.swipies.app/docs/dev/autokeyword_autoquestion.`,
      autoTags: 'Auto-tags',
...
`,
    ...
    knowledgeConfiguration: {
      ...
      tableColumnModeAutoDescription:
        'All columns are included in chunk text and stored as metadata (Swipies default).',
...
`,
      useRaptor: 'RAPTOR',
      useRaptorTip:
        'RAPTOR can be used for multi-hop question-answering tasks. Navigate to the Files page, click Generate > RAPTOR to enable it. See https://docs.swipies.app/docs/dev/enable_raptor for details.',
      prompt: 'Prompt',
      promptTip:
...
{cluster_content}`,
      ...
      vietnamese: 'Vietnamese',
      pageRank: 'Page rank',
      pageRankTip: `You can assign a higher PageRank score to specific datasets during retrieval. The corresponding score is added to the hybrid similarity scores of retrieved chunks from these datasets, increasing their ranking. See https://docs.swipies.app/docs/dev/set_page_rank for details.`,
      tagName: 'Tag',
      ...
      tagSet: 'Tag sets',
      tagSetTip: `
     <p> Select one or multiple tag datasets to auto-tag chunks in your dataset. See https://docs.swipies.app/docs/dev/use_tag_sets for details.</p>
...
<ul>
  ...
  <li>The auto-keyword feature is dependent on the LLM and consumes a significant number of tokens.</li>
      ...
      useGraphRagTip:
        'Construct a knowledge graph over file chunks of the current dataset to enhance multi-hop question-answering involving nested logic. See https://docs.swipies.app/docs/dev/construct_knowledge_graph for details.',
...
**Essential Rules:**
  ...
  - **Always consider** the entire conversation history.`,
      ...
      **Essential Rules:**
      ...
      variable: 'Variable',
      variableTip: `Used together with Swipies's chat assistant management APIs, variables can help develop more flexible system prompt strategies. The defined variables will be used by 'System prompt' as part of the prompts for the LLM. {knowledge} is a reserved special variable representing chunks retrieved from specified dataset(s), and all variables should be enclosed in curly braces {} in the 'System prompt'. See https://docs.swipies.app/docs/dev/set_chat_variables for details.`,
      add: 'Add',
      key: 'Key',
      ...
      sensitiveDataStorageWarning: 'Entered rules and information remain saved on our servers whether this toggle is ON or OFF. By toggling this switch, you agree to these terms.',
      featureDisabledNotice: 'Replacement feature is currently turned off, but your configured rules remain saved on our servers.',
      anonymizationRules: 'Replacement Rules',
      noSensitiveRules: 'No rules added yet. Click "Add Rule" to create one.',
      importTemplate: 'Import Template',
      importTemplateDialogTitle: 'Rule Import Format & Examples',
      importTemplateDialogDesc: 'You can import replacement rules using JSON or CSV format. Download a sample file below or format your file as shown in the examples.',
      downloadJsonTemplate: 'Download Sample JSON',
      downloadCsvTemplate: 'Download Sample CSV',
      searchValue: 'Search Value',
      replaceValue: 'Replace Value',
      caseSensitive: 'Case Sensitive',
      regex: 'RegEx',
      searchPlaceholder: 'e.g. John Doe',
      replacePlaceholder: 'e.g. CLIENT_NAME',
      model: 'Model',
      ...
      betaError:
        'Please acquire a Swipies API key from the System Settings page first.',
      searching: 'Searching...',
      parsing: 'Parsing',
      uploading: 'Uploading',
...
Example: Virtual Hosted Style`,
      ...
      deleteAccountDescription: 'Permanently delete your account. This action is irreversible.',
      deleteAccountBtn: 'Delete Account',
      deleteAccountConfirmTitle: 'Seriously? Delete Account? 😢',
      deleteAccountConfirmContent: 'Are you sure you want to leave the most epic AI platform ever created? All your settings, conversations, and custom agents will be deleted forever. We will miss you! 💔',
      logoutConfirmTitle: 'Log out 🚀',
      logoutConfirmContent: 'Are you sure you want to exit the coolest app in history? ✨',
      logoutConfirmOk: 'Yes, log out',
      ...
      referralDescription:
        'Invite friends to register and get rewarded: +1 GB Storage and +5 Agents/Apps for each successful referral!',
      ...
      agentsBonus: 'Agents Bonus',
      noReferralsYet: 'No referrals yet. Share your link to invite friends!',
      ...
      embeddingModelTip:
        'The default embedding model for each newly created dataset. If you cannot find an embedding model from the dropdown, check if you are using Swipies slim edition (which does not include embedding models) or check https://docs.swipies.app/docs/dev/supported_models to see if your model provider supports this model.',
      img2txtModel: 'VLM',
      img2txtModelTip:
        'The default VLM for each newly created dataset. It describes a picture or video. If you cannot find a model from the dropdown, check https://docs.swipies.app/docs/dev/supported_models to see if your model provider supports this model.',
      ...
      rerankModel: 'Rerank',
      rerankModelTip: `The default rerank model for reranking chunks. If you cannot find a model from the dropdown, check https://docs.swipies.app/docs/dev/supported_models to see if your model provider supports this model.`,
      ttsModel: 'TTS',
      ttsModelTip:
        'The default text-to-speech model. If you cannot find a model from the dropdown, check https://docs.swipies.app/docs/dev/supported_models to see if your model provider supports this model.',
      workspace: 'workspace',
      upgrade: 'Upgrade',
      addLlmTitle: 'Add LLM',
...
[Insert text here]`,
    ...
    license: {
      title: 'License Keys (Self-Hosted)',
      refresh: 'Refresh',
      description:
        'Manage Swipies AI license keys for deployment on your own servers and data centers.',
      keyCopied: 'License key copied!',
      envCopied: 'Environment variable for docker/.env copied!',
      keyDownloaded: 'License .key file downloaded!',
      renameSuccess: 'License name updated',
      renameError: 'Failed to update license name',
      revokeConfirm: 'Are you sure you want to revoke this license key?',
      revokeSuccess: 'License key revoked',
      revokeError: 'Failed to revoke license',
      commandCopied: 'Command copied',
      activeLicensesTitle: 'Active Licenses',
      oneKeyActive: '1 key active',
      keysActive: '{{count}} keys active',
      zeroKeys: '0 keys',
      localClusterDesc: 'Local secure cluster',
      readyToDeploy: 'Ready for node deployment',
      editionTypeTitle: 'Edition Type',
      selfHosted: 'Self-Hosted',
      enterprise: 'Enterprise',
      dataIsolationDesc: 'Local data isolation',
      unlimitedDocsLlm: 'Unlimited documents & LLMs',
      securityTitle: 'Security',
      rsa2048: 'RSA-2048',
      signature: 'Signature',
      offlineWorkDesc: 'Completely air-gapped operation',
      noExternalDeps: 'No external server dependencies',
      purchasedTitle: 'Purchased License Keys',
      totalKeys: 'Total keys:',
      loading: 'Loading license keys...',
      noKeysTitle: "You don't have any license keys yet",
      noKeysDesc:
        'Choose a subscription period below to instantly generate a cryptographic key for your on-premise Swipies AI instance.',
      choosePlanBelow: 'Choose a plan below',
      renamePlaceholder: 'Server/license name',
      save: 'Save',
      cancel: 'Cancel',
      defaultKeyName: 'Swipies Self-Hosted Key',
      rename: 'Rename',
      months: '{{count}} mo.',
      active: 'Active',
      revoke: 'Revoke license',
      rsaKey: 'RSA License Key',
      hide: 'Hide',
      showFullKey: 'Show full key',
      generatingKey: 'Generating key...',
      waitingGeneration: 'Awaiting generation...',
      copied: 'Copied',
      copy: 'Copy',
      downloadKey: 'Download key file',
      forEnv: 'For .env:',
      copiedToClipboard: 'Copied to clipboard',
      copyEnvSnippet: 'Copy string for .env',
      expires: 'Expires:',
      permanent: 'Permanent',
      expired: 'Expired',
      daysLeft: '{{count}} days left',
      guideTitle: 'Activation Guide on Your Server',
      guideSubtitle: 'How to apply the key in Docker Compose in 1 minute',
      step1Title: '1. Add the key to your Docker configuration:',
      step1Comment: "# In your repository's docker/.env file, add:",
      yourKeyPlaceholder: '<YOUR_COPIED_KEY>',
      step2Title: '2. Restart the application containers:',
      copyCommand: 'Copy command',
      guideNote:
        'The key is verified offline by the embedded cryptographic library. No internet connection is required for license validation.',
      purchaseTitle: 'Purchase a New License Key',
      purchaseSubtitle:
        'Select a suitable validity period. The license key is generated instantly upon payment confirmation.',
      tier6Title: 'Pilot / 6 Months',
      oneServer: '1 server',
      oneTime6Mo: 'One-time payment for 6 months',
      tier6Feat1: 'Unlimited documents and knowledge bases',
      tier6Feat2: 'Complete offline operation (Air-gapped)',
      tier6Feat3: 'Deployment in local Docker environment',
      tier6Feat4: 'Support via tickets and documentation',
      buy6Months: 'Buy for 6 months',
      ribbon2MonthsFree: '2 Months Free',
      tier12Title: 'Annual / 12 Months',
      bestPrice: 'Best Value',
      savings100k: 'Save 100,000 UZS compared to semi-annual',
      tier12Feat1: 'All benefits of the 6-month plan',
      tier12Feat2: 'Priority technical support line',
      tier12Feat3: 'Guaranteed future update compatibility',
      tier12Feat4: 'Industrial Kubernetes cluster support',
      buy12Months: 'Buy for 12 months (Best Value)',
    },
  },
};
