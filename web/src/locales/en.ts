...
Example: Virtual Hosted Style`,
      ...
      deleteAccountDescription: 'Permanently deactivate your personal account. Your profile and datasets will be archived but preserved, and you will be immediately logged out.',
      deleteAccountBtn: 'Deactivate Account',
      deleteAccountConfirmTitle: 'Deactivate Account Confirmation',
      deleteAccountConfirmContent: 'Are you sure you want to deactivate your account? This action will disable login and API access immediately. Your account status will be set to inactive while preserving your created datasets and system data.',
      maxTokens: 'Max tokens',
      maxTokensMessage: 'Max tokens is required',
      maxTokensTip: `The maximum context size of the model; an invalid or incorrect value will cause an error. Defaults to 512.`,
      maxTokensInvalidMessage: 'Please enter a valid number for Max tokens.',
