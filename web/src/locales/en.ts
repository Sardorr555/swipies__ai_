...
Example: Virtual Hosted Style`,
      ...
      deleteAccountDescription: 'Permanently delete your account. This action is irreversible, and your account cannot be recovered under any circumstances.',
      deleteAccountBtn: 'Delete Account',
      deleteAccountConfirmTitle: 'Delete Account Confirmation',
      deleteAccountConfirmContent: 'Are you sure you want to delete your account? This action is permanent and cannot be undone. You will be logged out immediately and you will not be able to restore this account or access its data again.',
      maxTokens: 'Max tokens',
      maxTokensMessage: 'Max tokens is required',
      maxTokensTip: `The maximum context size of the model; an invalid or incorrect value will cause an error. Defaults to 512.`,
      maxTokensInvalidMessage: 'Please enter a valid number for Max tokens.',
