          ...
          <FormItem className="flex flex-row items-center justify-between space-y-0">
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                {t('chat.sensitiveDataReplacementTip', 'If you use AI via API, you can mask sensitive information here so it is not shared with third parties and external companies.')}
              </p>
            </div>
            <FormControl>
              <Switch
