...
def get_secret_key():
    ...
    if SECRET_KEY and len(str(SECRET_KEY).strip()) >= 32:
        return SECRET_KEY
    # If not cached yet or invalid length, fetch/create it
...
def init_settings():
    ...
    if DOC_ENGINE == "elasticsearch":
        ...
        msgStoreConn = memory_gaussdb_conn.GaussDBMemoryConnection() if memory_gaussdb_conn else None
