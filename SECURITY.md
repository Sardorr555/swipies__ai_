...
The restricted_loads function at [api/utils/__init__.py#L215](https://github.com/Sardorr555/swipies__ai_.git/blob/main/api/utils/__init__.py#L215) is still vulnerable leading via code execution.
...
```
**Result**
![image](https://github.com/Sardorr555/swipies__ai_.git/assets/85293841/8e5ed255-2e84-466c-bce4-776f7e4401e8)
